...
import { ImageFull, ImageThumb } from "@/types/types";
...
export default function ProjectImageWDP({ data }: ProjectImageData) {
            ...
            <Section className="sm:flex">
              ...
              <Box className="p-8 sm:w-[312px]">
                ...
                <Section className="pt-4">
                  ...
                  <Text className="text-sm text-gray-400 block">4</Text>
                </Section>
                <Section className="pt-4">
                  <Dialog.Title className="DialogTitle text-2xl">
                  ...
                  <Text className="text-sm text-gray-400 block">
                    <ul className="leading-normal">
                      <li>
                        1. Product Owner{" "}
                        <Text className="text-xs">(Scrum, PM)</Text>
                      </li>
                      <li>
                        2. Full-Stack Engineer{" "}
                        <Text className="text-xs">(React.js, Node.js)</Text>
                      </li>
                      <li>
                        3. Backend Engineer{" "}
                        <Text className="text-xs">(Java)</Text>
                      </li>
                      <li>
                        4. Backend Engineer{" "}
                        <Text className="text-xs">(Node.js, Python)</Text>
                      </li>
                    </ul>{" "}
                  </Text>
                </Section>
